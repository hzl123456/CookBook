...
public class ProgressRequestBody extends RequestBody {
    ...
    public ProgressRequestBody(RequestBody requestBody, String fileName, UploadProgressListener progressListener) {
            ...
            public void write(Buffer source, long byteCount) throws IOException {
                ...
                Observable.just(writtenBytesCount).observeOn(AndroidSchedulers.mainThread()).subscribe(new Action1<Long>() {
                    ...
                    public void call(Long aLong) {
                        progressListener.onProgress(fileName, writtenBytesCount, totalBytesCount);
                    }
                });
            }
        };
